        ...
        <div className="grid gap-8 lg:grid-cols-2 text-start">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>{t("Settings.invoice.branding_desc")}</CardDescription>
                </CardHeader>
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    <Switch checked={settings.showTax} onCheckedChange={v => setSettings({ ...settings, showTax: v })} />
                    <Switch checked={settings.showDiscount} onCheckedChange={v => setSettings({ ...settings, showDiscount: v })} />
                    <Switch checked={settings.showHeader} onCheckedChange={v => setSettings({ ...settings, showHeader: v })} />
                    <Switch checked={settings.showFooter} onCheckedChange={v => setSettings({ ...settings, showFooter: v })} />
                </CardContent>
            </Card>
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <Input value={settings.companyTaxId} onChange={e => setSettings({ ...settings, companyTaxId: e.target.value })} />
                    <Input value={settings.footerNotes} onChange={e => setSettings({ ...settings, footerNotes: e.target.value })} />
                </CardContent>
            </Card>
