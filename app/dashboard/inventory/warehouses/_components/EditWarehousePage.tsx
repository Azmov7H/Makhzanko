            ...
            <Card className="border-none shadow-3xl bg-card/60 backdrop-blur-3xl rounded-[3rem] overflow-hidden relative group">
                ...
                <CardHeader className="p-10 border-b border-primary/5 bg-primary/5">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            <CardTitle className="text-2xl font-black italic">{t("Warehouses.edit_warehouse")}</CardTitle>
                            <CardDescription className="text-base font-medium mt-1">{t("Warehouses.edit_desc")}</CardDescription>
                        </div>
                    </div>
                </CardHeader>
