        ...
        >
            ...
            {products.length === 0 ? (
                <motion.div variants={itemVariants}>
                    <Card className="luxury-card p-24 bg-card/40 backdrop-blur-xl border-none shadow-3xl rounded-[3rem]">
                         <EmptyState
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <motion.div variants={itemVariants}>
                            <Card className="luxury-card p-8 group overflow-hidden relative border-none shadow-xl bg-card/40 backdrop-blur-xl rounded-[2.5rem]">
