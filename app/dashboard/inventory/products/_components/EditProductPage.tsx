...
import { Package, Save, RefreshCw, Sparkles, Box, Info } from "lucide-react";
            ...
            <Card className="border-none shadow-3xl bg-card/60 backdrop-blur-3xl rounded-[3rem] overflow-hidden relative group">
                ...
                <CardHeader className="p-10 border-b border-primary/5 bg-primary/5">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            <CardTitle className="text-2xl font-black italic">{t("Products.edit_product")}</CardTitle>
                            <CardDescription className="text-base font-medium mt-1">{t("Products.edit_desc")}</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                            ...
                            <div className="space-y-4">
                                ...
                                <Input
                                    ...
                                    className={cn(
                                        ...
                                        errors.sku && "border-destructive bg-destructive/5 text-destructive placeholder:text-destructive/40"
                                    )}
                                />
                            ...
                            >
                                ...
                                {isPending ? (
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-black text-sm uppercase tracking-widest">{t("Common.save_changes")}</span>
                                    </div>
                                )}
                            </Button>
                        </div>
