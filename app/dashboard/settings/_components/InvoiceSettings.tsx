  ...
  return (
    <div className="grid gap-8 lg:grid-cols-2 text-start">
      ...
      <div className="flex gap-4">
        <Button onClick={handleSave} disabled={!isDirty || loading} className="h-12 rounded-2xl shadow-xl shadow-primary/20 transition-all font-bold">
          <Save className="mr-2 h-4 w-4" />
          {loading ? t("Common.loading") : t("Settings.save_changes")}
        </Button>

        <Button variant="outline" asChild className="h-12 rounded-2xl border-primary/10 hover:bg-primary/5 transition-all font-bold">
          <a
