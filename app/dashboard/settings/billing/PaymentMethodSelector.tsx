                ...
                <DialogHeader className="p-8 pb-4 relative">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[9px] font-black text-primary/40 uppercase tracking-[0.3em]">Overhaul V2.1 Active</span>
                        </div>
                    </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <Input
                                                ...
                                                type="tel"
                                                className="h-16 pl-14 rounded-[1.5rem] bg-muted/50 border-border/40 focus:border-primary transition-all text-xl font-mono font-bold"
                                            />
                                        </div>
                                    </div>
