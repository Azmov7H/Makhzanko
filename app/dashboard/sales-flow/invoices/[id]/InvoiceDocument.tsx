                ...
                <div className="flex bg-card/80 backdrop-blur-2xl p-3 rounded-[2rem] border-2 border-primary/10 shadow-3xl items-center gap-3">
                    {canReturn && (
                        <Button
                            asChild
                            variant="ghost"
                            className="h-14 px-8 rounded-2xl gap-3 font-black text-sm hover:bg-primary/5 transition-all text-primary"
                        >
                            <Link href={`/dashboard/sales-flow/returns/new?invoiceId=${data.id}`}>
                                <RotateCcw className="h-5 w-5" />
                                <span className="uppercase tracking-widest">{t("Invoices.create_return")}</span>
                            </Link>
                        </Button>
                    )}
                    ...
                    <Button
                        onClick={handlePrint}
                        size="lg"
                        className="h-14 px-10 rounded-2xl gap-3 font-black text-lg shadow-2xl shadow-primary/20 hover:shadow-primary/40 transition-all hover:-translate-y-1 text-white bg-primary hover:bg-primary/90"
                    >
                        <Printer className="h-6 w-6" />
                        <span className="uppercase tracking-widest">{t("Invoices.print_invoice")}</span>
                    </Button>
                </div>
            </div>
