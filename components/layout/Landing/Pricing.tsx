    ...
    <section id="pricing" className="py-12 md:py-24 px-6 bg-background">
      <div className="container mx-auto">
        <motion.div
          ...
          className="text-center max-w-[400px] mx-auto mb-16"
        >
                ...
                <CardHeader className={`pt-12 pb-8 px-8 ${plan.popular ? "bg-primary/5" : ""}`}>
                  ...
                  <div className="flex items-baseline gap-2 mb-4 flex-wrap">
                    ...
                    <span className="text-muted-foreground font-medium text-lg">
                      {t("Common.currency")} / {t("Landing.pricing.month")}
                    </span>
                  </div>
                ...
                <CardContent className="flex-grow px-8 py-8 space-y-6">
                  <ul className="space-y-4">
                    {plan.features.map((feature, i) => (
                      ...
                      >
                        <div
                          className="size-5 rounded-full bg-green-500/10 flex items-center justify-center flex-shrink-0"
                          aria-hidden="true"
                        >
        ...
        >
          <p className="text-muted-foreground">
            {t("Landing.pricing.enterprise_query")}{" "}
            <Link href="/contact" className="text-primary font-bold hover:underline">
              {t("Landing.pricing.contact_us")}
            </Link>{" "}
            {t("Landing.pricing.custom_offer")}
          </p>
        </motion.div>
      </div>
    </section>
