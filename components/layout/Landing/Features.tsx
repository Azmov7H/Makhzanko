        ...
        <section id="features" className="relative py-12 md:py-24 bg-muted/30">
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <h3 className="text-3xl md:text-5xl font-black mb-6 text-foreground" style={{ fontFamily: "var(--font-amiri), serif" }}>
                            ...
                            <motion.div key={index} variants={itemVariants}>
                                ...
                                >
                                    ...
                                    <CardHeader className="relative z-10 pb-2">
                                        ...
                                        <CardTitle className="text-xl font-bold mb-2 group-hover:text-primary transition-colors" style={{ fontFamily: "var(--font-amiri), serif" }}>
                                            {feature.title}
                                        </CardTitle>
                                    </CardHeader>
