...
function NavSection({ section, role, mobile, onLinkClick, isCollapsed }: { section: NavSection, role: string, mobile?: boolean, onLinkClick?: () => void, isCollapsed?: boolean }) {
...
function NavItemLink({ item, onClick, isCollapsed }: { item: NavItem, onClick?: () => void, isCollapsed?: boolean }) {
