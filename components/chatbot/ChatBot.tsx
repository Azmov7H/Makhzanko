            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="w-[480px] max-w-[calc(100vw-40px)] h-[750px] max-h-[calc(100vh-80px)] deep-glass inner-glow premium-shadow rounded-[3rem] flex flex-col overflow-hidden relative"
                    >
                        {/* Ambient Glows */}
                        ...
                        <div className="px-6 py-4 glass bg-white/5 border-b border-white/10 flex items-center justify-between relative z-20">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-sm text-white tracking-tight font-cairo">{isRtl ? "مُحلل الأعمال" : "Insights Engine"}</h3>
                        ...
                        <AnimatePresence>
                            {showSettings && (
                                <motion.div
                                    ...
                                    className="absolute inset-0 z-30 glass-dark bg-slate-950/95 p-8 flex flex-col pt-24"
                                >
                                    ...
                                    <div className="flex-1 overflow-y-auto space-y-3 pr-2 scrollbar-thin">
                                        {DIALECTS.map((d) => (
                                            <button
                                                ...
                                                className={cn(
                                                    "w-full flex items-center justify-between p-5 rounded-2xl glass border transition-all duration-300",
                                                    currentDialect === d.id
                                ...
                                <div className="relative flex-1">
                                    ...
                                    <div className={`absolute inset-y-0 ${isRtl ? "left-0 pl-1" : "right-0 pr-1"} flex items-center`}>
                                        <Button
                                            ...
                                            className="h-14 w-14 rounded-2xl bg-white text-slate-950 hover:bg-white hover:scale-105 transition-all shadow-2xl shadow-white/10 active:scale-95 disabled:opacity-30 disabled:hover:scale-100"
                                        >
